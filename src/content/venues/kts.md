...
venue: kts
description: >-
  Kai Tak Stadium is the 50,000-capacity centrepiece of Kai Tak Sports Park and
  Hong Kong's largest stadium. A retractable roof supports all-weather sports,
...
openingHoursIntro: >-
  ...
  published by the organiser and may differ by ticket zone.
openingHoursIntroZh: >-
  主場館看台按已編排活動開放，並無固定每日公眾參觀時間。開閘時間、指定到場
  路線及再次入場規則由主辦單位公布，並可能按門票區域而異。
openingHours:
...
transport: >-
  ...
  events use controlled walking and departure routes, so public transport and
  the organiser's assigned approach are strongly recommended.
transportZh: >-
  宋皇臺站及啟德站均可前往體育園，前往主場館一般以宋皇臺站較方便。滿座活動
  會實施指定步行及離場路線，強烈建議使用公共交通並依主辦單位指定路線前往。
transportMethods:
  - { label: "MTR", labelZh: "港鐵", value: "Tuen Ma Line to Sung Wong Toi or Kai Tak Station; allow about 10 minutes on foot", valueZh: "乘屯馬綫至宋皇臺站或啟德站，再步行約10分鐘", lines: [{ label: "Tuen Ma Line", labelZh: "屯馬綫", color: "#923011" }], links: [{ label: "MTR Kai Tak travel guide", labelZh: "港鐵啟德乘車攻略", url: "https://www.mtr.com.hk/en/customer/main/kaitak-sports-park-mtr.html" }] }
  - { label: "Bus, minibus and ferry", labelZh: "巴士、小巴及渡輪", value: "Services reach the wider park and Kowloon City area; the North Point-Kowloon City ferry is another option", valueZh: "多條路線服務園區及九龍城一帶，亦可乘北角至九龍城渡輪", links: [{ label: "KMB", labelZh: "九巴", url: "https://www.kmb.hk/en/" }, { label: "Citybus", labelZh: "城巴", url: "https://www.citybus.com.hk/routes/index.aspx?intLangID=1" }, { label: "Sun Ferry", labelZh: "新渡輪", url: "https://www.sunferry.com.hk/en/route-and-fare/timetable?route=north-point-to-kowloon-city" }] }
  - { label: "Taxi and drop-off", labelZh: "的士及上落客", value: "Use the park's designated taxi or private-car drop-off zones", valueZh: "使用體育園指定的士或私家車上落客區", links: [{ label: "Kai Tak Sports Park directions", labelZh: "啟德體育園交通指南", url: "https://www.kaitaksportspark.com.hk/getting-here" }, { label: "Transport Department taxi guide", labelZh: "運輸署的士指南", url: "https://www.td.gov.hk/en/transport_in_hong_kong/public_transport/taxi/index.html" }] }
  - { label: "Parking", labelZh: "泊車", value: "Public car parks are available, but roads and parking may be restricted during major events", valueZh: "設有公共停車場，但大型活動期間道路及泊車可能受限制", links: [{ label: "Kai Tak Sports Park parking", labelZh: "啟德體育園泊車資訊", url: "https://www.kaitaksportspark.com.hk/getting-here" }] }
address: "Kai Tak Sports Park, 38-39 Shing Kai Road, Kowloon, Hong Kong"
addressZh: "香港九龍承啟道38至39號啟德體育園"
mapNote: "The map is centred on Kai Tak Stadium within the southern side of Kai Tak Sports Park."
...
facilitiesIntro: >-
  ...
  audience rules vary with the sports or concert configuration.
facilitiesIntroZh: >-
  主場館各層設有現代化大堂、無障礙座位、餐飲及活動支援設施。實際閘口、
  餐飲點及觀眾規則視乎體育或演唱會佈置。
facilities:
  - { title: "Accessibility", titleZh: "無障礙設施", description: "Step-free routes, ramps, lifts, accessible seating and toilets, tactile or Braille guidance, and hearing-support facilities are provided. Contact the organiser before the event for accessible ticketing or assistance.", descriptionZh: "場館設無梯級通道、斜道、升降機、無障礙座位及洗手間、觸感或盲文指引，以及聽覺支援設施。無障礙票務或協助請於活動前聯絡主辦單位。" }
