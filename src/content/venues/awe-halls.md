...
transport: >-
  ...
  return planning, so check the organiser's transport notice and last-train
  timetable before travelling.
transportZh: >-
  亞洲國際博覽館站位於場館內，再依館內指示前往6、8或10號展館。演出完結
  較晚時需要預先規劃回程，出發前請查看主辦單位交通通知及尾班車時間。
transportMethods:
  - { label: "Airport Express", labelZh: "機場快綫", value: "Direct to AsiaWorld-Expo Station; follow in-building signs to Hall 6, 8 or 10", valueZh: "直達亞洲國際博覽館站；再依館內指示前往6、8或10號展館", lines: [{ label: "Airport Express", labelZh: "機場快綫", color: "#00888a" }], links: [{ label: "Airport Express", labelZh: "機場快綫", url: "https://www.mtr.com.hk/en/customer/services/airport_express_index.html" }] }
