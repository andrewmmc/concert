...
const messages = {
  en: {
    ...
    siteDescription: 'Interactive 3D seating-plan viewer for Hong Kong concert venues.',
    ogDescription: 'Explore Hong Kong concert venues in 3D — hover or search for any seat.',
    canvasLabel: '3D view of the venue seating plan. Hover or click a seat to select it, or search for a seat by section, row and seat number.',
    venue: 'Venue',
  ...
  'zh-HK': {
    siteName: '香港演唱會座位視圖',
    siteDescription: '香港演唱會場地互動 3D 座位表。',
    ogDescription: '以 3D 模型瀏覽香港演唱會場地，並可指向或搜尋任何座位。',
    canvasLabel: '場館座位表的 3D 視圖。指向或按一下座位即可選取，亦可按區域、行及座位號碼搜尋。',
    venue: '場館',
    seatingLayout: '座位配置',
    comingSoon: '即將推出',
