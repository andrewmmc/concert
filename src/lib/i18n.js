...
const messages = {
  en: {
    ...
    homePathEyebrow: 'Start here',
    homePathTitle: 'Everything around the concert, not just the seat.',
    homePathBody: 'Choose what you need now. Each guide lives on its own focused page.',
    beforeYouGo: 'Before you go',
    beforeYouGoBody: 'Tickets, arrival time, bags, transport and post-show planning.',
    seeAllConcerts: 'All upcoming concerts',
    seeAllConcertsBody: 'Browse shows by date and venue from one calendar.',
    compareVenues: 'Venue guides',
    compareVenuesBody: 'Opening information, transport, facilities, comments and seat tools.',
    openPage: 'Open guide',
    guidePageEyebrow: 'Concert-going handbook',
    guidePageTitle: 'The things worth knowing before show day.',
    guidePageBody: 'A practical Hong Kong checklist from buying the ticket to catching the last train home.',
    guideTicketTitle: 'Before buying',
    guideTicketBody: 'Check the exact venue, seating layout, restricted-view notes and ticket collection method.',
    guideArrivalTitle: 'Before doors open',
    guideArrivalBody: 'Allow time for station crowds, security checks, merchandise queues and finding the correct entrance.',
    guideInsideTitle: 'Inside the venue',
    guideInsideBody: 'Keep your ticket ready, follow photography rules and locate washrooms before the show begins.',
    guideAfterTitle: 'After the encore',
    guideAfterBody: 'Expect crowd controls and plan an alternative route if the nearest station becomes congested.',
    guideAccessibilityTitle: 'Accessibility',
    guideAccessibilityBody: 'Confirm step-free station exits, accessible entrances and companion-seat arrangements in advance.',
    venueIndexTitle: 'Venue directory',
    venueIndexBody: 'Open a dedicated page for practical venue information, upcoming events, comments and the separate 3D seat viewer.',
    venueDetails: 'Venue details',
    openingHours: 'Opening hours',
    transportAndMaps: 'Transport & maps',
    ...
    concertPageEyebrow: 'Hong Kong concert calendar',
    concertPageTitle: 'All upcoming concerts.',
    concertPageBody: 'A dedicated event index for browsing dates, venues and ticket-sale reminders. Listings are placeholders for now.',
    ...
    heroBoardTitle: 'Venue board',
    heroBoardNote: 'Pick a venue to open its interactive 3D seat map.',
    ...
    venueDirectoryTitle: 'Venue directory',
  ...
  'zh-HK': {
    ...
    homePathEyebrow: '由這裡開始',
    homePathTitle: '不只座位，而是演唱會前後需要的一切。',
    homePathBody: '先選擇你需要的資訊，每一項指南都有獨立專頁。',
    beforeYouGo: '入場前須知',
    beforeYouGoBody: '門票、到場時間、攜帶物品、交通及散場安排。',
    seeAllConcerts: '所有即將舉行的演唱會',
    seeAllConcertsBody: '按日期及場館，在同一個日曆瀏覽演出。',
    compareVenues: '場館指南',
    compareVenuesBody: '開放資訊、交通、設施、評語及座位工具。',
    openPage: '開啟指南',
    guidePageEyebrow: '演唱會入場手冊',
    guidePageTitle: '演出當日之前，值得預先知道的事。',
    guidePageBody: '由購票到乘搭尾班車回家，一份為香港樂迷而設的實用清單。',
    guideTicketTitle: '購票之前',
    guideTicketBody: '確認正確場館、座位配置、視線受阻提示及取票方式。',
    guideArrivalTitle: '開場之前',
    guideArrivalBody: '預留時間應付車站人流、保安檢查、周邊商品隊伍及尋找正確入口。',
    guideInsideTitle: '進入場館',
    guideInsideBody: '準備好門票、留意攝影規則，並在演出開始前確認洗手間位置。',
    guideAfterTitle: 'Encore 之後',
    guideAfterBody: '預計散場人流管制；若最近車站擠塞，預先準備另一條回程路線。',
    guideAccessibilityTitle: '無障礙安排',
    guideAccessibilityBody: '預先確認車站無梯級出口、無障礙入口及陪同者座位安排。',
    venueIndexTitle: '場館目錄',
    venueIndexBody: '每個場館都有獨立專頁，整理實用資訊、即將舉行的活動、評語及分開的 3D 座位視圖。',
    venueDetails: '場館詳情',
    openingHours: '開放時間',
    transportAndMaps: '交通及地圖',
    photoAlbum: '相片集',
    coverPreview: '場館封面預覽',
    ...
    concertPageEyebrow: '香港演唱會日曆',
    concertPageTitle: '所有即將舉行的演唱會。',
    concertPageBody: '獨立演出索引，方便按日期、場館及售票提示瀏覽。現階段顯示的是版面預覽。',
    ...
    heroBoardTitle: '場館一覽',
    heroBoardNote: '選擇場館，開啟互動 3D 座位圖。',
