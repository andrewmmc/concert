...
const messages = {
  en: {
    ...
    siteDescription: 'Interactive 3D seating plans with stage views from individual seats in Hong Kong concert venues.',
    ogDescription: 'Explore Hong Kong concert venues in 3D and see the stage from individual seats.',
    canvasLabel: '3D view of the venue seating plan. Click or search for a seat to see its view of the stage.',
    venue: 'Venue',
    ...
    selectSeatHint: 'Click a seat to see its view of the stage',
  ...
  'zh-HK': {
    siteName: '香港演唱會座位視圖',
    siteDescription: '香港演唱會場地互動 3D 座位表，提供個別座位的舞台視角。',
    ogDescription: '以 3D 模型瀏覽香港演唱會場地，並從個別座位觀看舞台。',
    canvasLabel: '場館座位表的 3D 視圖。按一下或搜尋座位，即可以該座位的視角觀看舞台。',
    venue: '場館',
    seatingLayout: '座位配置',
    comingSoon: '即將推出',
    ...
    selectSeatHint: '按一下座位，即可以該座位的視角觀看舞台',
    viewFromSeat: '座位視角',
    unselectSeat: '取消選擇座位',
