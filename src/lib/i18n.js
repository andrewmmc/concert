...
const messages = {
  en: {
    ...
    navTerms: 'Terms',
    navPrivacy: 'Privacy',
    footerNavLabel: 'Legal and operator links',
    ...
    venueInformation: 'Contact & official information',
    ...
    seatControls: 'Choose or find a seat',
